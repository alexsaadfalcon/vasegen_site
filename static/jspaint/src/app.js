...
window.default_brush_size = 7;
window.default_eraser_size = 8;
window.default_airbrush_size = 9;
window.default_pencil_size = 7;
window.default_stroke_size = 7; // applies to lines, curves, shape outlines
// declared like this for Cypress tests
...
const $news_indicator = $(`
	<a class='news-indicator' href='#project-news'>
		<img src='/static/jspaint/images/winter/present.png' width='24' height='22' alt=''/>
...
function init_eye_gaze_mode() {
	...
	.append(
		...
		.css({
			...
			width: 24,
			height: 24,
			backgroundImage: "url(/static/jspaint/images/classic/undo.svg)",
		})
	);
	...
	.on("click", ()=> {
		...
		.find("div").css({
			backgroundImage:
				paused ?
				"url(/static/jspaint/images/classic/eye-gaze-unpause.svg)" :
				"url(/static/jspaint/images/classic/eye-gaze-pause.svg)",
		});
	})
	.appendTo($floating_buttons)
	.css({
	...
	.append(
		...
		.css({
			...
			width: 24,
			height: 24,
			backgroundImage: "url(/static/jspaint/images/classic/eye-gaze-pause.svg)",
		})
	);
